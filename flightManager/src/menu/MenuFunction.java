...
public class MenuFunction {
    ...
    public MenuFunction() {
        try {
            String flightFileName = "flight.dat";
            flightList.readFlightDataFromFile(flightFileName);

            String passengerFileName = "passenger.dat";
            passengerManager.readPassengerDataFromFile(passengerFileName);
            
            String checkinFileName = "checkin.dat";
            checkinManager.readCheckinDataFromFile(checkinFileName);
